...
using LeoStarterFactory.Infrastructure;
...
namespace LeoStarterFactory.ServiceDefaults;
...
public static class Extensions
{
    ...
    {
        builder.AddNpgsqlDbContext<AppDbContext>(ServiceNames.PostgresDatabase);
